  ...
  let content = (
    <>
      <Grid
        ...
        alignItems="center"
        sx={{
          boxShadow: '1px 0px 15px 3px #6A6A6A',
          borderRadius: '9px',
          padding: '30px 0',
        }}
      >
        ...
        <Typography variant="h6" textAlign="center" mt={5}>
          ...
          <br />
          You have 10,000$ budget, each win will multiply the budget in two and from each loss,
          2000$ will be reduced
        </Typography>
        <Typography
          variant="h5"
          fontWeight="bold"
  ...
  if (gameStarted) {
    content = (
      <Grid container flexDirection="column" alignItems="center">
        ...
        <Grid item>
          <Typography variant="h4" fontWeight="bold" textTransform="uppercase" mt={3}>
            {isShowed ? message : 'Choose biggest card'}
          </Typography>
        </Grid>
